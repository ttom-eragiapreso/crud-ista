    ...
    <div class="container">
        ...
        <form action="{{ route('games.update', $game) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="name" class="form-control" id="name" placeholder="The name of your game"
                    value="{{ $game->name }}">
            </div>
            <div class="mb-3">
                <label for="genres" class="form-label">Game Genres</label>
                <input type="text" name="genres" placeholder="The genres of your games" value="{{ $game->genres }}">
            </div>
            <div class="mb-3">
